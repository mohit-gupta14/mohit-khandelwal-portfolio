      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredProjects.map((project, idx) => (
          <motion.div
            ...
            className="cursor-pointer group p-6 rounded-3xl bg-slate-900/90 border border-white/10 hover:border-rn-cyan/40 shadow-mobile-card hover:shadow-2xl transition-all duration-300 flex flex-col justify-between relative overflow-hidden"
          >
            {/* Ambient hover glow */}
            ...
            <div>
              ...
              <div className="flex items-start justify-between gap-3 mb-4">
                <div className="w-13 h-13 rounded-2xl bg-gradient-to-tr from-cyan-500/20 via-indigo-500/20 to-purple-500/20 border border-white/15 p-3 flex items-center justify-center text-white font-mono font-bold shadow-md group-hover:scale-105 transition-transform">
                  <Smartphone className="w-6 h-6 text-rn-cyan" />
                </div>
              ...
              {/* Title & Subtitle */}
              <h3 className="text-lg font-bold text-white group-hover:text-rn-cyan transition-colors tracking-tight">
                {project.title}
              </h3>
              ...
              {/* Impact Tag Line */}
              <div className="mt-4 p-2.5 rounded-xl bg-white/[0.03] border border-white/5 space-y-1">
            ...
            <div className="mt-6 pt-3 border-t border-white/5 flex items-center justify-between">
              <span className="text-xs text-slate-400 group-hover:text-white transition-colors flex items-center gap-1 font-medium">
                Tap to Inspect Specs
                <ArrowUpRight className="w-3.5 h-3.5 text-rn-cyan group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </span>
              <span className="px-3 py-1 rounded-xl bg-rn-cyan/15 group-hover:bg-rn-cyan group-hover:text-slate-950 text-rn-cyan text-xs font-bold transition-all">
                Open Sheet
              </span>
            </div>
          </motion.div>
