    ...
    <section id="about" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <motion.div
          ...
          className="lg:col-span-5 p-6 sm:p-7 rounded-3xl bg-slate-900/90 border border-white/10 shadow-mobile-card space-y-6"
        >
          {/* Mobile Profile Card Header */}
          <div className="flex items-center gap-4 pb-5 border-b border-white/10">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-cyan-500/20 to-indigo-500/20 border-2 border-rn-cyan/50 flex items-center justify-center text-white font-extrabold text-2xl shadow-rn-glow-sm">
              MK
            </div>
            <div>
              ...
              <p className="text-xs text-rn-cyan font-medium">
                {profileData.title}
              </p>
          ...
          <div className="space-y-2.5">
            ...
            <div className="p-3 rounded-xl bg-white/[0.03] border border-white/5 space-y-1">
              <div className="flex items-center justify-between text-xs">
                <strong className="text-white">Anktech Software Pvt. Ltd.</strong>
                <span className="text-[10px] font-mono text-emerald-400">Sep 2021 – Present</span>
              </div>
            ...
            <div className="p-3 rounded-xl bg-white/[0.03] border border-white/5 space-y-1">
              <div className="flex items-center justify-between text-xs">
                <strong className="text-white">iLant Health (Healthcare)</strong>
                <span className="text-[10px] font-mono text-rn-cyan">Feb 2026 – Present</span>
              </div>
              <p className="text-[11px] text-slate-400">
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-br from-cyan-950/30 to-indigo-950/20 border border-rn-cyan/20">
          ...
          <div className="p-3.5 rounded-xl bg-rn-cyan/10 border border-rn-cyan/25 flex items-center gap-3">
            <ShieldCheck className="w-6 h-6 text-rn-cyan flex-shrink-0" />
            <div>
          ...
          {engineeringPillars.map((pillar, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-5 rounded-3xl bg-slate-900/80 border border-white/10 hover:border-rn-cyan/40 shadow-mobile-card transition-all duration-300 flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div className="p-2.5 rounded-xl bg-white/[0.04] border border-white/10 group-hover:scale-105 transition-transform">
                  ...
                  <h4 className="text-base font-bold text-white group-hover:text-rn-cyan transition-colors">
                    {pillar.title}
                  </h4>
                ...
                <div className="mt-4 pt-3 border-t border-white/5 flex items-center text-[11px] text-slate-400 group-hover:text-slate-200 transition-colors">
